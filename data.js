...
const OWNERSHIP_DATA = {
  ...
  "charliebcollection.ca": { brand: "Charlie B", ownership: "Canada", category: "Apparel & Fashion", hq: "Montreal, Quebec", note: "Canadian womenswear label founded in 2014, with its head office and design team in Montreal's fashion district.", confidence: "high",
    alternatives: [] },
  "kaliyana.com": { brand: "Kaliyana", ownership: "Canada", category: "Apparel & Fashion", hq: "Ottawa, Ontario", note: "Canadian designer label making contemporary and avant-garde womenswear, with its own store in Ottawa.", confidence: "high",
    alternatives: [] },
  "legaleriste.info": { brand: "Le Galeriste", ownership: "Canada", category: "Apparel & Fashion", hq: "Montreal, Quebec", madeIn: "Canada", note: "Montreal 'wearable art' company that prints artists' work on garments and pays them from the sales. States that products are made entirely in its own Canadian factory.", confidence: "high",
    alternatives: [] },
  "thighsociety.com": { brand: "Thigh Society", ownership: "Canada", category: "Apparel & Fashion", hq: "Toronto, Ontario", note: "Canadian, woman-owned company making anti-chafing base layers, operating since 2009.", confidence: "high",
    alternatives: [] },
  "nettlestale.com": { brand: "Nettle's Tale", ownership: "Canada", category: "Apparel & Fashion", hq: "Vancouver, British Columbia", madeIn: "Canada", note: "Vancouver swimwear and apparel label founded by Julia Church, size-inclusive (XS-4X) and made in Vancouver.", confidence: "high",
    alternatives: [] },
  "smokinglily.com": { brand: "Smoking Lily", ownership: "Canada", category: "Apparel & Fashion", hq: "Victoria, British Columbia", madeIn: "Canada", note: "Independent Victoria label operating since 1996, with garments designed, sewn and silkscreened in house.", confidence: "high",
    alternatives: [] },
  "anianmfg.com": { brand: "ANIAN", ownership: "Canada", category: "Apparel & Fashion", hq: "Victoria, British Columbia", madeIn: "Canada", note: "Makes menswear and womenswear from recycled natural wool and cotton fibres, manufactured in Canada — one of the few Canadian labels doing recycled-fibre production domestically rather than offshore.", confidence: "high",
    alternatives: [] },
  "hooke.com": { brand: "Hooke", ownership: "Canada", category: "Apparel & Fashion", hq: "Quebec City, Quebec", note: "Quebec outdoor apparel brand, born and based in Quebec City.", confidence: "high",
    alternatives: [] },
  "chlorophylle.com": { brand: "Chlorophylle", ownership: "Canada", category: "Apparel & Fashion", hq: "Chicoutimi, Quebec", note: "Canadian outdoor clothing brand founded in Chicoutimi in 1980.", confidence: "high",
    alternatives: [] },
  "kollontai.net": { brand: "Kollontai", ownership: "Canada", category: "Apparel & Fashion", hq: "Montreal, Quebec", madeIn: "Canada", note: "Womenswear label by designer Gabrielle Tousignant, operating since 1998 and entirely designed and manufactured in Montreal.", confidence: "high",
    alternatives: [] },
  "fdjcollection.com": { brand: "FDJ French Dressing Jeans", ownership: "Canada", category: "Apparel & Fashion", hq: "Montreal, Quebec", note: "Canadian denim and womenswear brand designed in Montreal, operating for over 40 years.", confidence: "high",
    alternatives: [] },
  "advikaclothing.com": { brand: "Advika", ownership: "Canada", category: "Apparel & Fashion", hq: "Montreal, Quebec", madeIn: "Canada", note: "Montreal loungewear and basics label, Canadian-made from sustainable fabrics.", confidence: "high",
    alternatives: [] },
  "daubanddesign.com": { brand: "Daub + Design", ownership: "Canada", category: "Apparel & Fashion", hq: "Vancouver, British Columbia", madeIn: "Canada", note: "Vancouver womenswear label using hand-painted prints, describing itself as Canadian-made.", confidence: "high",
    alternatives: [] },
  "deuxpardeux.com": { brand: "Deux par Deux", ownership: "Canada", category: "Apparel & Fashion", hq: "Montreal, Quebec", note: "Montreal children's and baby clothing company operating since 1986.", confidence: "high",
    alternatives: [] },
  "pinkmartinicollection.com": { brand: "Pink Martini Collection", ownership: "Canada", category: "Apparel & Fashion", hq: "Toronto, Ontario", note: "Canadian womenswear brand founded in Toronto in 2006 by creative director Amir Bahar.", confidence: "high",
    alternatives: [] },
  "muskokabearwear.com": { brand: "Muskoka Bear Wear", ownership: "Canada", category: "Apparel & Fashion", hq: "Bracebridge, Ontario", madeIn: "Canada", note: "Started in 2003 and now the largest original clothing brand in central Ontario, with stores in Bala, Bracebridge, Gravenhurst, Huntsville and Port Carling. States its hoodies, tees and pants are Ontario-made.", confidence: "high",
    alternatives: [] },
  "eastcoastlifestyle.com": { brand: "East Coast Lifestyle", ownership: "Canada", category: "Apparel & Fashion", hq: "Halifax, Nova Scotia", note: "Founded in 2013 by Alex MacLean while a student at Acadia University, built around an anchor logo as an Atlantic Canadian identity brand.", confidence: "high",
    alternatives: [] },
  "hanlyncollective.com": { brand: "Hanlyn Collective", ownership: "Canada", category: "Apparel & Fashion", hq: "Ontario", note: "Canadian direct-to-consumer label founded in 2020 making bamboo lyocell lounge and playwear for infants through adults. Designed in Canada.", confidence: "high",
    alternatives: [] },
  "blueskyclothingco.com": { brand: "Blue Sky Clothing Co.", ownership: "Canada", category: "Apparel & Fashion", hq: "Canada", madeIn: "imported", note: "Canadian clothing company whose own site describes its production as overseas, with its ethical-manufacturing commitments framed around those offshore workshops. Canadian-owned, not Canadian-made.", confidence: "high",
    alternatives: [] },
  "blnts.com": { brand: "Bluenotes", ownership: "Canada", category: "Apparel & Fashion", hq: "Toronto, Ontario", note: "Founded in Toronto in 1942 as Thrifty's. American Eagle Outfitters bought and rebranded it in 2000, then sold the division in 2004 to YM Inc., a privately held Canadian fashion group — so it returned to Canadian ownership two decades ago.", confidence: "high",
    alternatives: [] },
  "suzannesfashions.ca": { brand: "Suzanne's Fashions", ownership: "Canada", category: "Apparel & Fashion", hq: "Canada", note: "Canadian women's apparel retailer operating for more than 55 years.", confidence: "high",
    alternatives: [] },
  "shepherdsfashions.com": { brand: "Shepherd's Fashions", ownership: "Canada", category: "Apparel & Fashion", hq: "Ottawa, Ontario", note: "Ottawa-based independent women's fashion boutique, which stocks a dedicated Canadian designers section — a retailer rather than a manufacturer.", confidence: "high",
    alternatives: [] },
  ...
  "bearandroo.com": { brand: "Bear & Roo", ownership: "Canada", category: "Apparel & Fashion", hq: "Saskatchewan", madeIn: "Canada", note: "Made-to-order children's and family apparel sewn one piece at a time in founder Jen's Saskatchewan studio after each order is placed, with a 5-8 week turnaround. About as far from fast fashion as a clothing business gets.", confidence: "high",
    alternatives: [] },
  "buttercreamclothing.com": { brand: "Buttercream Clothing", ownership: "Canada", category: "Apparel & Fashion", hq: "Calgary, Alberta", madeIn: "Canada", note: "Size-inclusive loungewear and basics manufactured in house in Calgary rather than outsourced, on a slow-fashion model with stated fair-wage commitments.", confidence: "high",
    alternatives: [] },
  "anghill.com": { brand: "Ang Hill", ownership: "Canada", category: "Apparel & Fashion", hq: "Alberta", madeIn: "Canada", note: "Womenswear label designed in house and produced locally in small batches, which the company says is how it keeps control of fit and quality rather than sending production overseas.", confidence: "high",
    alternatives: [] },
  "clothesandroads.com": { brand: "Clothes & Roads", ownership: "Canada", category: "Apparel & Fashion", hq: "Quebec", madeIn: "Canada", note: "Minimalist travel clothing made in Quebec, including zero-waste pieces cut from fabric scraps left over from the main collections.", confidence: "high",
    alternatives: [] },
  "seedpants.com": { brand: "Seed (Seed Pants)", ownership: "Canada", category: "Apparel & Fashion", hq: "Calgary, Alberta", madeIn: "Canada", note: "Organic hemp and cotton pants, 100% sewn in Calgary by a local team the company says earns a living wage. Founded by Blake Ward. Note there is a separate Canadian business also called Seed — see seedstyle.ca, which is a retailer, not this brand.", confidence: "high",
    alternatives: [] },
  "seedstyle.ca": { brand: "Seed Sustainable Style", ownership: "Canada", category: "Apparel & Fashion", hq: "Canada", note: "Canadian sustainable-fashion retailer founded by Lisa Wicklund, curating other labels rather than manufacturing its own. Not the same business as Seed Pants of Calgary, despite the shared name.", confidence: "high",
    alternatives: [] },
  "simplymerino.com": { brand: "Simply Merino", ownership: "Canada", category: "Apparel & Fashion", hq: "Vancouver, British Columbia", madeIn: "Canada", materialsFrom: "imported", note: "Family-owned Vancouver company making merino wool apparel for adults and children, designed and ethically made in Vancouver. The wool itself comes from certified non-mulesed Australian farms — Canadian sewing, imported fibre, which is the norm rather than the exception here.", confidence: "high",
    alternatives: [] },
  "dotty.ca": { brand: "Dotty", ownership: "Canada", category: "Apparel & Fashion", hq: "Toronto, Ontario", madeIn: "Canada", note: "Woman-owned Toronto label founded by Heather Bolt, a 25-year veteran of the industry, with garments designed and manufactured at Toronto factories in sizes XS-2X.", confidence: "high",
    alternatives: [] },
  "kimco.ca": { brand: "Kim & Co.", ownership: "Canada", category: "Apparel & Fashion", hq: "Montreal, Quebec", madeIn: "Canada", note: "Female-founded Montreal label established in 1988 by Kim Mendelson, stating all garments are made in Canada, in sizes XS-XXXL.", confidence: "high",
    alternatives: [] },
  "nomidesigns.net": { brand: "Nomi Designs", ownership: "Canada", category: "Apparel & Fashion", hq: "Victoria, British Columbia", madeIn: "Canada", materialsFrom: "imported", note: "Minimalist linen clothing handcrafted in the company's own Victoria studio. The linen itself is European — another case of Canadian making with imported cloth.", confidence: "high",
    alternatives: [] },
  "hu-ha.com": { brand: "HUHA", ownership: "Canada", category: "Apparel & Fashion", hq: "Vancouver, British Columbia", note: "Vancouver company founded in 2019 by Alexa Suter, making zinc-infused underwear, and backed by Canadian investors including District Ventures Capital. Worth knowing: the website says orders ship from the US, which is a fulfilment arrangement rather than a change of ownership — the company is Canadian.", confidence: "high",
    alternatives: [] },
  "figclothing.ca": { brand: "FIG Clothing", ownership: "Canada", category: "Apparel & Fashion", hq: "Montreal, Quebec", note: "Travel and lifestyle apparel for women, designed in Montreal's Mile End and describing itself as Canadian owned and operated. Manufacturing location is not published, so it is left unstated here.", confidence: "high",
    alternatives: [] },
  "indyeva.com": { brand: "Indyeva", ownership: "Canada", category: "Apparel & Fashion", hq: "Montreal, Quebec", note: "Montreal outdoor and technical apparel brand for women. Manufacturing location is not published, so it is left unstated rather than assumed.", confidence: "high",
    alternatives: [] },
  "shoplazypants.com": { brand: "Lazypants", ownership: "Canada", category: "Apparel & Fashion", hq: "Toronto, Ontario", note: "Premium sweatpants and loungewear. The company describes itself as designed in Canada — note that 'designed in' is not the same claim as 'made in', and it does not state where the garments are sewn.", confidence: "high",
    alternatives: [] },
  "banquetworkshop.com": { brand: "Banquet Atelier & Workshop", ownership: "Canada", category: "Apparel & Fashion", hq: "Vancouver, British Columbia", note: "Design studio and shop on Granville Island in Vancouver, selling apparel alongside prints and home goods. Manufacturing location is not published.", confidence: "high",
    alternatives: [] },
  "noreasterapparel.com": { brand: "Nor'easter Apparel", ownership: "Canada", category: "Apparel & Fashion", hq: "Martins Point, Nova Scotia", madeIn: "Canada", note: "Nova Scotia brand printing Maritime-slang tees by hand in its own studio between Mahone Bay and Chester, with a Halifax presence, rather than outsourcing printing.", confidence: "high",
    alternatives: [] },
  "newscotlandclothing.ca": { brand: "New Scotland Clothing Co.", ownership: "Canada", category: "Apparel & Fashion", hq: "Dartmouth, Nova Scotia", madeIn: "Canada", note: "Nova Scotia heritage apparel — tartan and lion designs on tees, hoodies and headwear — under the line 'Made Near. Worn Far.', with production kept in Canada.", confidence: "high",
    alternatives: [] },
  "picadilly.ca": { brand: "Picadilly Canada", ownership: "Canada", category: "Apparel & Fashion", hq: "Canada", madeIn: "Canada", note: "Canadian womenswear label carrying Made in Canada on its own storefront. Ownership details are not published — flagged so a reader who knows can tell us.", confidence: "verify",
    alternatives: [] },
  "cazzapetitezacks.com": { brand: "Cazza Petite & Zacks", ownership: "Canada", category: "Apparel & Fashion", hq: "Quebec / Kitchener, Ontario", note: "Two long-running Canadian retailers now under one banner: Cazza Petite, founded in Quebec in 1986 as the first Quebec company focused on petite women's clothing, and Zacks, founded in Kitchener in 1921. Describes itself as the largest reseller of Tribal in Canada — worth noting Tribal itself is US-owned. A retailer, not a manufacturer.", confidence: "high",
    alternatives: [] },
  "6amworkshirts.com": { brand: "6AM WorkShirts", ownership: "Canada", category: "Apparel & Fashion", hq: "Canada", madeIn: "Canada", note: "Sweat-proof dual-fabric dress shirts aimed at hospitality work, priced in Canadian dollars and carrying Made in Canada messaging. The company does not publish its ownership or location — flagged for confirmation.", confidence: "verify",
    alternatives: [] },
  "zippyjamz.com": { brand: "ZippyJamz", ownership: "Canada", category: "Apparel & Fashion", hq: "Canada", note: "Baby sleepwear with a two-way zipper design for night-time diaper changes, using GOTS-certified organic cotton and bamboo. Canadian-facing and priced in Canadian dollars, but the company publishes neither ownership nor manufacturing location — flagged rather than assumed.", confidence: "verify",
    alternatives: [] },
  "pook.ca": { brand: "Pook", ownership: "Canada", category: "Apparel & Fashion", hq: "Canada", note: "Known for work-sock-pattern toques, mittens and onesie pyjamas. Canadian-operated, but the company publishes neither ownership nor manufacturing location — flagged for confirmation.", confidence: "verify",
    alternatives: [] },
